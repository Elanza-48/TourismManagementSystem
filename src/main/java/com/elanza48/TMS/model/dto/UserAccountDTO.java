...
import com.elanza48.TMS.model.entity.UserAccount.UserAccountStatus;
import com.elanza48.TMS.model.entity.UserAccount.UserGender;
import com.elanza48.TMS.model.entity.UserAccount.UserRole;
...
public class UserAccountDTO extends ContactDTO{
	...
	public String toString() {
		return "UserAccount [role=" + role + ", status=" + status + ", dob=" + dob + ", email=" + email
