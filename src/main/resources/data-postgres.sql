...
insert into main.destination_info(id, name, description, province, max_stay_duration, created_at, last_update) values
    ((select uuid_generate_v4()), 'Manali', 'Himachal Pradesh', 'Manali', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Ladakh', 'UT of Leh and Ladakh', 'Ladakh', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Jammu','UT of Jammu and Kashmir', 'Jammu', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Kashmir','UT of Jammu and Kashmir', 'Kashmir', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Hawa Mahal','Located in Jaipur' ,'Rajasthan', 2, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Sri Harmandir Sahib','The Golden Temple, Located In Amritsar' ,'Rajasthan', 1, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Rishikesh','Himalayan foothills beside the Ganges River' ,'Uttarakhand', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Nainital','Set around Nainital Lake' ,'Uttarakhand', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Jama Masjit','In Delhi' ,'New Delhi', 1, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Kolkata','City of Joy' ,'West Bengal', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Gir National Park','Wild Life Sanctuary' ,'Gujarat', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Ajanta Caves','The Buddhist Caves in Ajanta' ,'Maharashtra', 2, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Bannerghatta National Park','Bannerghatta National Park' ,'Karnataka', 4, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Athirappilly Water Falls','In Thrissur District in Kerala' ,'Kerala', 4, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Ooty','In Western Ghats mountains' ,'Tamil Nadu', 7, (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Andaman and Nicobar Islands','Andaman and Nicobar Islands' ,'Andaman and Nicobar', 10, (select localtimestamp), null);
...
insert into main.hotel_info(id, name, district, state, street, zip, email, mobile_no, base_price, type, dest_id, created_at, last_update) values
    ((select uuid_generate_v4()), 'Montana Blues Resort','Manali', 'Himachal Pradesh','MDR 29, Prini',175103, 'montanabluesresort@gmail.com', 7468952136, 1586, 'PRIME',(select id from main.destination_info where name='Manali'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'The Grand Dragon Ladakh','Leh', 'Ladakh','Old Road Sheynam', 194101, 'granddragonhotel@outlook.com', 6589746812, 11582, 'ROYAL',(select id from main.destination_info where name='Ladakh'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Radisson Blu Jammu','Jammu', 'Jammu','Radisson Square, Narwal Bala, Bypass Road',180006, 'radissonbluhotel@gmail.com', 8569552136, 3000, 'PRIME',(select id from main.destination_info where name='Jammu'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'H.B Zaindari Palace','Srinagar', 'Kashmir','Dal Lake Shikara Ghat 14 Nehru Park',190001, 'zaindaripalace@hotmail.com', 9685647124, 2000, 'STANDARD',(select  id from main.destination_info where name='Kashmir'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Trident Jaipur','Jaipur', 'Rajasthan','Amber Fort Road, Opposite Jal Maha',302002, 'tridenthoteljaipur@yahoo.com', 4569832168, 4500, 'ROYAL',(select id from main.destination_info where name='Hawa Mahal'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Fairfield by Marriott Amritsar','Amritsar', 'Punjab','Albert Road',143001, 'fairfieldhotel@outlook.com', 8564756921, 3865, 'STANDARD',(select  id from main.destination_info where name='Sri Harmandir Sahib'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Ganga Kinare','Rishīkesh', 'Uttarakhand','237 Virbhadra Road',249201, 'gangakinareresort@hotmail.com', 5692314768, 8576, 'ROYAL',(select  id from main.destination_info where name='Rishikesh'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Lakeside Inn','Nainital', 'Uttarakhand','Mall Road',263002, 'hotellakesideinn@gmail.com', 5874635012, 3586, 'PRIME',(select  id from main.destination_info where name='Nainital'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Mannat international','Paharganj', 'New Delhi','9346 multani dhanda',110055, 'hotelmannatinternational@gmail.com', 6897235014, 1586, 'STANDARD',(select  id from main.destination_info where name='Jama Masjit'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'ITC Royal Bengal','Kolkata', 'West Bengal','1 JBS Haldane Avenue',700046, 'royalbengal@yahoo.com', 7569832005, 5832, 'ROYAL',(select  id from main.destination_info where name='Kolkata'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Anil Farmhouse','Sasan Gir', 'Gujarat','Village Bhalchel',362135, 'anilfarmhouseresort@outlook.com', 4698332158, 2986, 'STANDARD',(select  id from main.destination_info where name='Gir National Park'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Vivanta','Aurangabad', 'Maharashtra','8-N - 12 , CIDCO, Rauza Bagh, Navkhanda',431003, 'Vivantamaharashtra@hotmail.com', 3258965449, 4238, 'PRIME',(select  id from main.destination_info where name='Ajanta Caves'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Radiant Resort','Bangalore', 'Karnataka','C K Palya Road, 17 th km Bannerghatta road',560083, 'radiantresort@gmail.com', 1212587699, 3476, 'STANDARD',(select  id from main.destination_info where name='Bannerghatta National Park'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Casa Rio Resorts','Athirappilly', 'Kerala','P.O Vettilappara, Chalakkudy Trissur',680724, 'casarioresorts@outlook.com', 6698745321, 7500, 'PRIME',(select  id from main.destination_info where name='Athirappilly Water Falls'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Treebo Trend Sky Dale Inn & Suites','Ooty', 'Tamil Nadu','284, Ooty West Lake Road (Thettukkal Road)',643004, 'skydaleinn@hotmail.com', 5398746588, 1586, 'STANDARD',(select id from main.destination_info where name='Ooty'), (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Hotel De Pebbles','Port Blair', 'Andaman and Nicobar','Jawaharlal Nehru Road Ground',744102, 'hoteldepebbles@yahoo.com', 2458762457, 2957, 'STANDARD',(select  id from main.destination_info where name='Andaman and Nicobar Islands'), (select localtimestamp), null);

insert into main.transport_info(id, name, description, public, mode, created_at, last_update) values
    ((select uuid_generate_v4()), 'Slik route transports', 'Delux bus service', false, 'BUS', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Ozone car rentals', 'Comfort to day car service', false, 'CAR', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'UTC', 'Uttarakhand Transport Corporation', true, 'BUS', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Palace on Wheels', 'Experience royalty at its finest', true, 'RAILWAY', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Vector car rentals', 'Speedy and Comfort', false, 'CAR', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Himsagar Express', 'From Kashmir to Kanyakumari.', true, 'RAILWAY', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Indigo', 'The Lean clean machine', false, 'FLIGHT', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Omega waterways', 'Experts on waterways', false, 'STEAMER', (select localtimestamp), null),
    ((select uuid_generate_v4()), 'Sea Hawk Luxury', 'Serve the best on water', false, 'CRUISE', (select localtimestamp), null);

insert into main.tour_package(id, name, activities, description, events, active, created_at, last_update) values
    ((select  uuid_generate_v4()), 'Amazing Himalayas','Hill views, Side seeing, Traking', 'Amazing Views of himalayan range', 'Local Art and culture', true, (select localtimestamp), null),
    ((select  uuid_generate_v4()), 'Couple Goals','Forest Views, Side seeing, Traking', 'Amazing Places for Honeymoon', 'Local Art and culture, Safari', true, (select localtimestamp), null),
    ((select  uuid_generate_v4()), 'Spiritual Mighty','Hill views, Temple view, Traking', 'Enjoy the places almighty', 'Temple/Mosque/Gurdwara Darshan', true, (select localtimestamp), null),
    ((select  uuid_generate_v4()), 'Holiday Enclave','Hill views, Side seeing, Traking, Sea side View', 'Enjoy hills and the sea in true pleasure', 'Surfing, Sky Paragliding, Snorkling, Scuba Diving, Rope Way', true, (select localtimestamp), null),
    ((select  uuid_generate_v4()), 'City Lights','City views, Side seeing, City/Town roam', 'Amazing Views of city and village.', 'Local Art and culture, foods, night party ', false, (select localtimestamp), null);
...
insert into main.booking_info(id, date, passenger_count, price, r_type, status, t_date, pkg_id, usr_id, created_at, last_update) values
    ((select uuid_generate_v4()),to_date('20170415','YYYYMMDD'),4,38465,'SUPERIOR','COMPLETE',to_date('20171003','YYYYMMDD'),(select id from main.tour_package where name='Couple Goals'),(select id from main.user_account where email='mesheha46@yahoo.com'), (select localtimestamp), null),
    ((select uuid_generate_v4()),to_date('20190123','YYYYMMDD'),7,85745,'DELUXE','CANCELLED',to_date('20190611','YYYYMMDD'),(select id from main.tour_package where name='City Lights'),(select id from main.user_account where email='yadavji82@outlook.com'), (select localtimestamp), null),
    ((select uuid_generate_v4()),to_date('20180329','YYYYMMDD'),3,25283,'SUPERIOR','COMPLETE',to_date('20180907','YYYYMMDD'),(select id from main.tour_package where name='Spiritual Mighty'),(select id from main.user_account where email='kpkaur98@hotmail.com'), (select localtimestamp), null),
    ((select uuid_generate_v4()),to_date('20191013','YYYYMMDD'),10,158921,'SUPERIOR','COMPLETE',to_date('20200209','YYYYMMDD'),(select id from main.tour_package where name='Holiday Enclave'),(select id from main.user_account where email='gunjana93@hotmail.com'), (select localtimestamp), null),
    ((select uuid_generate_v4()),to_date('20211022','YYYYMMDD'),5,65897,'SUPERIOR','ACTIVE',to_date('20220612','YYYYMMDD'),(select id from main.tour_package where name='Holiday Enclave'),(select id from main.user_account where email='yadavji82@outlook.com'), (select localtimestamp), null);
...
insert into main.payment_info(id, date, discount, gst, mode, net_charge, status, txn_id, booking_id, created_at , last_update) values
    ((select uuid_generate_v4()),to_date('20170415','YYYYMMDD'),0, 38465*0.18, 'WALLET',38465,'SUCCESS',(select uuid_generate_v4()),
     (select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='mesheha46@yahoo.com' and bi.date=to_date('20170415','YYYYMMDD')), (select localtimestamp), null),

    ((select uuid_generate_v4()),to_date('20190123','YYYYMMDD'),0, 85745*0.18, 'UPI',85745,'SUCCESS',(select uuid_generate_v4()),
     (select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='yadavji82@outlook.com' and bi.date=to_date('20190123','YYYYMMDD')), (select localtimestamp), null),

     ((select uuid_generate_v4()),to_date('20180329','YYYYMMDD'),0, 25283*0.18, 'INTERNET_BANKING',25283,'SUCCESS',(select uuid_generate_v4()),
     (select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='kpkaur98@hotmail.com' and bi.date=to_date('20180329','YYYYMMDD')), (select localtimestamp), null),

    ((select uuid_generate_v4()),to_date('20191013','YYYYMMDD'),0, 158921*0.18, 'CARD',158921,'SUCCESS',(select uuid_generate_v4()),
     (select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='gunjana93@hotmail.com' and bi.date=to_date('20191013','YYYYMMDD')), (select localtimestamp), null),

    ((select uuid_generate_v4()),to_date('20211022','YYYYMMDD'),0, 65897*0.18, 'WALLET',65897,'PENDING',(select uuid_generate_v4()),
     (select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='yadavji82@outlook.com' and bi.date=to_date('20211022','YYYYMMDD')), (select localtimestamp), null);
...
insert into main.booking_transport_ticket(id, date, seat_no, booking_id, transport_id, created_at ,last_update) values
    ...
    ((select uuid_generate_v4()),to_date('20170415','YYYYMMDD'),'85D1',(select bi.id from main.booking_info as bi, main.user_account as usr where bi.usr_id=usr.id and usr.email='gunjana93@hotmail.com' and bi.t_date=to_date('20200209','YYYYMMDD')),
     (select ptm.transport_id from main.package_transport_map as ptm, main.booking_info as bi, main.user_account as usr, main.transport_info as ti where ptm.pkg_id=bi.pkg_id and ptm.transport_id=ti.id and ti.mode='CRUISE' and bi.usr_id=usr.id and usr.email='gunjana93@hotmail.com'  and bi.t_date=to_date('20200209','YYYYMMDD')), (select localtimestamp), null);
...
insert into main.hotel_review(id, date, rating, review, booking_id, hotel_id ,created_at, last_update) values
    ...
    ((select uuid_generate_v4()),to_date('20181009','YYYYMMDD'),6,'Good and Comfort Stay !', (select bi.id from main.booking_info as bi, main.user_account as usr where  usr.email='kpkaur98@hotmail.com' and bi.t_date=to_date('20180907','YYYYMMDD')),
     (select hi.id from main.user_account as usr, main.booking_info as bi, main.tour_package as tp, main.package_destination_map as pdm, main.destination_info as di, main.hotel_info as hi where usr.email='kpkaur98@hotmail.com' and usr.id=bi.usr_id and bi.pkg_id=tp.id and bi.t_date=to_date('20180907','YYYYMMDD') and tp.id=pdm.pkg_id and pdm.dest_id=di.id and di.name='Rishikesh' and di.id=hi.dest_id), (select localtimestamp), null),
    ...
    ((select uuid_generate_v4()),to_date('20200326','YYYYMMDD'),8,'Good Quality Rooms !', (select bi.id from main.booking_info as bi, main.user_account as usr where  usr.email='gunjana93@hotmail.com' and bi.t_date=to_date('20200209','YYYYMMDD')),
     (select hi.id from main.user_account as usr, main.booking_info as bi, main.tour_package as tp, main.package_destination_map as pdm, main.destination_info as di, main.hotel_info as hi where usr.email='gunjana93@hotmail.com' and usr.id=bi.usr_id and bi.pkg_id=tp.id and bi.t_date=to_date('20200209','YYYYMMDD') and tp.id=pdm.pkg_id and pdm.dest_id=di.id and di.name='Andaman and Nicobar Islands' and di.id=hi.dest_id), (select localtimestamp), null);
...
insert into main.enquiry(id, date, subject, body, booking_id, enq_open, created_at, last_update) values
    ((select uuid_generate_v4()), to_date('20190427','YYYYMMDD'),'Cancellation of My Booking.','Sir,\n Due to some unavoidable circumstance I will not be able to continue my journey in the trip. So I want cancel my booking. \nKindly help me. \nThank you',
     (select bi.id from main.user_account as usr, main.booking_info as bi where usr.email='yadavji82@outlook.com' and usr.id=bi.usr_id and bi.t_date=to_date('20190611','YYYYMMDD')),false, (select localtimestamp), null);
